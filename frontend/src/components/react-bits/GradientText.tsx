/**
 * GradientText — React Bits 渐变文字动画
 * NOTE: 动态渐变色扫过文字效果，用于标题特效
 * 源自 https://reactbits.dev/text-animations/gradient-text
 */
...
export default function GradientText({
  children,
  className = '',
  colors = ['#3eede7', '#5EB8AC', '#053154', '#3eede7'],
  animationSpeed = 8,
  showBorder = false,
  ...
  return (
    ...
    >
      {showBorder && (
        ...
        >
          <div
            className="absolute bg-nexus-bg rounded-[1.25rem] z-[-1]"
            style={{
              width: 'calc(100% - 2px)',
              height: 'calc(100% - 2px)',
              left: '50%',
