...
/** 可选主题 */
const THEMES = [
  { id: 'dark', label: '深色', desc: '默认 · 赛博工业风', icon: Moon },
  { id: 'light', label: '浅色', desc: '明亮清爽', icon: Sun },
  { id: 'system', label: '跟随系统', desc: '自动适配', icon: Monitor },
];
                  ...
                  >
                    ...
                    <div className="px-5 pt-5 pb-4">
                      <div className="flex items-center gap-3.5">
                        ...
                        <button
                          onClick={onClose}
                          className="p-1.5 rounded-md text-nexus-muted hover:text-nexus-primary hover:bg-nexus-bg transition-all"
                        >
                          <X size={16} />
                        </button>
                      </div>
                    ...
                    <div className="p-2">
                      {isLoggedIn ? (
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-rose-400 hover:bg-rose-400/10 transition-all group"
                        >
                          <LogOut
                            size={17}
                        ...
                        <button
                          onClick={handleLogin}
                          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-nexus-primary hover:bg-nexus-primary/10 transition-all group"
                        >
                          <LogIn
                            size={17}
                            className="group-hover:translate-x-0.5 transition-transform"
...
function NavItem({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-nexus-bg transition-all group"
    >
...
function SubPanelHeader({
  ...
  return (
    <div className="px-4 py-3 border-b border-nexus-border flex items-center gap-3 bg-nexus-surface-alt/30">
      <button
        onClick={onBack}
        className="p-1 rounded-md text-nexus-muted hover:text-nexus-primary hover:bg-nexus-bg transition-all rotate-180"
      >
